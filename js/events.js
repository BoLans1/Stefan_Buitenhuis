...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function createEventCard(event) {
        ...
        // Bepaal badge label en klasse op basis van categorie
        let badgeHTML = '';
        if (event.category) {
            let badgeLabel = '';
            let badgeClass = '';
            ...
            switch (event.category) {
                case 'pro':
                    ...
                    break;
                case 'wedstrijd':
                    badgeLabel = 'Wedstrijd';
                    badgeClass = 'badge-wedstrijd';
                    break;
                case 'eigen':
                    badgeLabel = 'Eigen Show';
                    badgeClass = 'badge-eigen';
                    break;
                case 'openmic':
                    badgeLabel = 'Open Mic';
                    badgeClass = 'badge-openmic';
                    break;
            }

            if (badgeLabel) {
                badgeHTML = `<span class="event-badge ${badgeClass}">${badgeLabel}</span>`;
            }
        }
